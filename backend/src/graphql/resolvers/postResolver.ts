...
export default {
  ...
  Mutation: {
    ...
    schedulePostToSegments: handleUncaughtError(
      postController.schedulePostToSegments
    ),
    schedulePostToPersons: handleUncaughtError(
      postController.schedulePostToPersons
    ),
  },
  Post: {
